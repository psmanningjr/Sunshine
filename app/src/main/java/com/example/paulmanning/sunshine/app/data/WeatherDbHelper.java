...
import com.example.paulmanning.sunshine.app.data.WeatherContract.LocationEntry;
import com.example.paulmanning.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    private void createLocationTable(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_LOCATION_TABLE = "CREATE TABLE " + LocationEntry.TABLE_NAME + " (" +
                ...
                // To assure the application have just one location entry per description
                // per location, it's created a UNIQUE constraint with REPLACE strategy
